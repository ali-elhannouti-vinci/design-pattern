public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1=new RobotImpl.RobotBuilder("Freddy Fazbear")
				.firePower(10)
				.shieldPower(2)
				.shootingSpeed(100)
				.build();// un robot avec un canon de 10, un bouclier de 2, une fr�quence de tir de 100 et qui a re�u une am�lioration de canon multipliant la puissance de ce dernier par 2.
		Robot robot2=new RobotImpl.RobotBuilder("Bender")
				.firePower(9)
				.shieldPower(3)
				.shootingSpeed(90)
				.build();// un robot avec un canon de 9, un bouclier de 3, une fr�quence de tir de 90
